...
Stripe segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Stripe** | US | payments API (provedor dos dados do usuário) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [stripe@mcp.ai](mailto:stripe@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
